...
const ::uint32_t TableStruct_ping_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
::uint8_t* Ping::_InternalSerialize(
  ...
  // repeated int32 num = 3;
  {
    int byte_size = _impl_._num_cached_byte_size_.Get();
    if (byte_size > 0) {
...
// @@protoc_insertion_point(message_byte_size_start:ping.Ping)
  ...
  // repeated int32 num = 3;
  {
    ...
    _impl_._num_cached_byte_size_.Set(cached_size);
