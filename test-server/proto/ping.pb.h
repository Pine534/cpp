...
PROTOBUF_NAMESPACE_OPEN
template <>
::ping::Ping* Arena::CreateMaybeMessage<::ping::Ping>(Arena*);
template <>
::ping::Pong* Arena::CreateMaybeMessage<::ping::Pong>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Ping final :
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _num_cached_byte_size_;
